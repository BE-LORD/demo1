export default function Pricing() {
  ...
  return (
    <section id="pricing" className="py-12 sm:py-20 px-4 bg-bg-deep">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-8 sm:gap-12 items-center max-w-5xl mx-auto">
          <div className="px-2">
            <h3 className="font-cabinet font-extrabold text-white-pearl text-2xl sm:text-3xl mb-4">
              Price confirmed<br />before you ride.
            </h3>
            <p className="font-satoshi text-white-pearl/60 leading-relaxed mb-6 text-sm sm:text-base">
            ...
            <button
              ...
              className="border-2 border-electric-teal text-electric-teal rounded-full px-6 sm:px-8 py-3 font-satoshi font-semibold active:bg-electric-teal active:text-bg-deepest transition-all duration-300 text-sm sm:text-base w-full sm:w-auto touch-manipulation"
            >
              Get a Free Quote
            </button>
          </div>
          ...
          <div className="space-y-3 sm:space-y-4">
            {notes.map((note, i) => (
              <div key={i} className="flex items-start gap-3 sm:gap-4 p-4 sm:p-5 bg-bg-card border border-electric-teal/10 rounded-xl sm:rounded-2xl active:border-electric-teal/25 transition-colors">
                ...
                <div>
                  <h4 className="font-cabinet font-bold text-white-pearl mb-1 text-sm sm:text-base">{note.title}</h4>
                  <p className="font-satoshi text-xs sm:text-sm text-white-pearl/60">{note.desc}</p>
                </div>
              </div>
            ))}
          </div>
